pipeline {
    ...
    parameters {
        ...
        string(defaultValue: 'ssh://git.maple.maceroc.com/git/millegrilles_documents', name: 'GIT_URL')
        string(defaultValue: 'registry.millegrilles.com:5000/millegrilles/documents_rust', name: 'DOCKER_IMAGE')
    }

    environment {
        NOM_APP="millegrilles_documents"
